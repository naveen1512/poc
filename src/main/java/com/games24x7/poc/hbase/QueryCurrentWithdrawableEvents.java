...
//                }
            ...
            long endEpoch = Instant.now().toEpochMilli();
//            System.out.println("Thread " + Thread.currentThread().getId() + " Profile ended: " + endEpoch);

            System.out.println("Thread " + Thread.currentThread().getId() + " Total Milliseconds: " + (endEpoch - startEpoch));
        } catch (IOException e) {
            // TODO Auto-generated catch block
            e.printStackTrace();
        }
